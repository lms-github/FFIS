...
namespace Solution1.Win
{
    ...
    public partial class Solution1WindowsFormsApplication : WinApplication
    {
        ...
        private void Solution1WindowsFormsApplication_CustomizeLanguagesList(object sender, CustomizeLanguagesListEventArgs e)
        {
        ...
        private void Solution1WindowsFormsApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e)
        {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
